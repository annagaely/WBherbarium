...
<html>
  <head>
    ...
    <!-- Favicon-->
    <link rel="shortcut icon" href="<?php echo base_url();?>assets/bower_components/userside/img/favicon.png">
  ...
  <body>
        ...
        <div class="container"><a href="./" class="navbar-brand"><img src="img/logo.svg" alt="" class="img-fluid"></a>
          ...
          <div id="navbarSupportedContent" class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
                  <!-- Link-->
                  <li class="nav-item"> <a href="<?php echo base_url();?>assets/bower_components/userside/index.html" class="nav-link active">Home</a></li>
                  <!-- Link-->
                  <li class="nav-item"> <a href="<?php echo base_url();?>assets/bower_components/userside/faq.html" class="nav-link">FAQ</a></li>
                  <!-- Link-->
                  <li class="nav-item"> <a href="<?php echo base_url();?>assets/bower_components/userside/contact.html" class="nav-link">Contact</a></li>
                  <!-- Link-->
    ...
    <section class="hero">
      <div class="container mb-5">
        <div class="row align-items-center">
          ...
          <div class="col-lg-6"><img src="<?php echo base_url();?>assets/bower_components/userside/img/illustration-hero.svg" alt="..." class="hero-image img-fluid d-none d-lg-block"></div>
        </div>
      </div>
    </section>
    <!-- Intro Section-->
    <section>
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-7 mx-auto mt-5"><img src="<?php echo base_url();?>assets/bower_components/userside/img/illustration-1.svg" alt="..." class="intro-image img-fluid"></div>
        </div>
      </div>
    </section>
    <!-- Divider Section-->
          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="box text-center">
                <div class="icon d-flex align-items-end"><img src="<?php echo base_url();?>assets/bower_components/userside/img/monitor.svg" alt="..." class="img-fluid"></div>
            ...
            <div class="col-lg-4">
              <div class="box text-center">
                <div class="icon d-flex align-items-end"><img src="<?php echo base_url();?>assets/bower_components/userside/img/target.svg" alt="..." class="img-fluid"></div>
            ...
            <div class="col-lg-4">
              <div class="box text-center">
                <div class="icon d-flex align-items-end"><img src="<?php echo base_url();?>assets/bower_components/userside/img/chat.svg" alt="..." class="img-fluid"></div>
            ...
            <div class="col-lg-4">
              <div class="box text-center">
                <div class="icon d-flex align-items-end"><img src="<?php echo base_url();?>assets/bower_components/userside/img/idea.svg" alt="..." class="img-fluid"></div>
            ...
            <div class="col-lg-4">
              <div class="box text-center">
                <div class="icon d-flex align-items-end"><img src="<?php echo base_url();?>assets/bower_components/userside/img/coffee-cup.svg" alt="..." class="img-fluid"></div>
            ...
            <div class="col-lg-4">
              <div class="box text-center">
                <div class="icon d-flex align-items-end"><img src="<?php echo base_url();?>assets/bower_components/userside/img/pen.svg" alt="..." class="img-fluid"></div>
    ...
    <section class="bg-gray">
      <div class="container">
        ...
        <div class="clients mt-5">
          <div class="row">
            <div class="col-lg-2"><img src="<?php echo base_url();?>assets/bower_components/userside/img/client-1.svg" alt="" class="client-image img-fluid"></div>
            <div class="col-lg-2"><img src="<?php echo base_url();?>assets/bower_components/userside/img/client-2.svg" alt="" class="client-image img-fluid"></div>
            <div class="col-lg-2"><img src="<?php echo base_url();?>assets/bower_components/userside/img/client-3.svg" alt="" class="client-image img-fluid"></div>
            <div class="col-lg-2"><img src="<?php echo base_url();?>assets/bower_components/userside/img/client-4.svg" alt="" class="client-image img-fluid"></div>
            <div class="col-lg-2"><img src="<?php echo base_url();?>assets/bower_components/userside/img/client-5.svg" alt="" class="client-image img-fluid"></div>
            <div class="col-lg-2"><img src="<?php echo base_url();?>assets/bower_components/userside/img/client-6.svg" alt="" class="client-image img-fluid"></div>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="pb-0">
      <div class="container">
        ...
        <div class="portfolio mt-5">
          <div class="row">
            <div class="col-lg-4 p-0"><a href="<?php echo base_url();?>assets/bower_components/userside/img/portfolio-1.jpg" data-lightbox="image-1" data-title="Some footer information" class="portfolio-item"><img src="<?php echo base_url();?>assets/bower_components/userside/img/portfolio-1.jpg" alt="image" class="img-fluid"></a></div>
            <div class="col-lg-4 p-0"><a href="<?php echo base_url();?>assets/bower_components/userside/img/portfolio-2.jpg" data-lightbox="image-1" data-title="Some footer information" class="portfolio-item"><img src="<?php echo base_url();?>assets/bower_components/userside/img/portfolio-2.jpg" alt="image" class="img-fluid"></a></div>
            <div class="col-lg-4 p-0"><a href="<?php echo base_url();?>assets/bower_components/userside/img/portfolio-3.jpg" data-lightbox="image-1" data-title="Some footer information" class="portfolio-item"><img src="<?php echo base_url();?>assets/bower_components/userside/img/portfolio-3.jpg" alt="image" class="img-fluid"></a></div>
            <div class="col-lg-4 p-0"><a href="<?php echo base_url();?>assets/bower_components/userside/img/portfolio-4.jpg" data-lightbox="image-1" data-title="Some footer information" class="portfolio-item"><img src="<?php echo base_url();?>assets/bower_components/userside/img/portfolio-4.jpg" alt="image" class="img-fluid"></a></div>
            <div class="col-lg-4 p-0"><a href="<?php echo base_url();?>assets/bower_components/userside/img/portfolio-5.jpg" data-lightbox="image-1" data-title="Some footer information" class="portfolio-item"><img src="<?php echo base_url();?>assets/bower_components/userside/img/portfolio-5.jpg" alt="image" class="img-fluid"></a></div>
            <div class="col-lg-4 p-0"><a href="<?php echo base_url();?>assets/bower_components/userside/img/portfolio-6.jpg" data-lightbox="image-1" data-title="Some footer information" class="portfolio-item"><img src="<?php echo base_url();?>assets/bower_components/userside/img/portfolio-6.jpg" alt="image" class="img-fluid"></a></div>
          </div>
        </div>
      </div>
    </section>
