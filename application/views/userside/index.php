    ...
    <section class="heroo">
      <div class="container mb-5">
        <div class="row align-items-center">
          ...
          <div class="col-lg-6"><img src="<?php echo base_url();?>assets/bower_components/logoto.png" alt="..." class="hero-image img-fluid d-none d-lg-block"></div>
        </div>
      </div>
    </section>
    <!-- Intro Section-->
      ...
      <div class="container">
        ...
        <div class="integrations mt-5">
          <div class="row">
            ...
            <div class="col-lg-4">
              <div class="box text-center">
                <div class="icon d-flex align-items-end"><img src="<?php echo base_url();?>assets/bower_components/userside/img/chat.png" alt="..." class="img-fluid"></div>
            ...
            <div class="col-lg-4">
              <div class="box text-center">
                <div class="icon d-flex align-items-end"><img src="<?php echo base_url();?>assets/bower_components/userside/img/idea.png" alt="..." class="img-fluid"></div>
            ...
            <div class="col-lg-4">
              <div class="box text-center">
                <div class="icon d-flex align-items-end"><img src="<?php echo base_url();?>assets/bower_components/userside/img/coffee-cup.png" alt="..." class="img-fluid"></div>
            ...
            <div class="col-lg-4">
              <div class="box text-center">
                <div class="icon d-flex align-items-end"><img src="<?php echo base_url();?>assets/bower_components/userside/img/pen.png" alt="..." class="img-fluid"></div>
      ...
      <div class="container">
        ...
        <div class="clients mt-5">
          <div class="row" style="margin-left: 50px;">
            <div class="col-lg-2"><img src="<?php echo base_url();?>assets/bower_components/userside/img/client-1.png" alt="" class="client-image img-fluid"></div>
            <div class="col-lg-2"><img src="<?php echo base_url();?>assets/bower_components/userside/img/client-2.png" alt="" class="client-image img-fluid"></div>
            <div class="col-lg-2"><img src="<?php echo base_url();?>assets/bower_components/userside/img/client-3.png" alt="" class="client-image img-fluid"></div>
