...
<div class="mx-4">
   <div class="col-md-20 mt-4" id="divTablePendingV">
      <div class="card  px-3 py-3 ">
        <div class="table-responsive">
          <table class="table table-striped table-hover" id="querytblPendingV">
            <thead>
              <tr role="row">
                <th scope="col" width= "10%">Visit ID</th>
                <th scope="col" width= "20%">Visitor's Name </th>
  ...
  <div class="mx-4">
   <div class="col-md-20 mt-4" id="divTableForVisitingV">
      <div class="card  px-3 py-3 ">
        <div class="table-responsive">
          <table class="table table-striped table-hover" id="querytblForVisitingV">
            <thead>
              <tr role="row">
                <th scope="col" width= "10%">Visit ID</th>
                <th scope="col" width= "20%">Visitor's Name </th>
  ...
  <div class="mx-4">
   <div class="col-md-20 mt-4" id="divTableRejectedV">
      <div class="card  px-3 py-3 ">
        <div class="table-responsiveV">
          <table class="table table-striped table-hover" id="querytblRejected">
            <thead>
              <tr role="row">
                <th scope="col" width= "10%">Visit ID</th>
                <th scope="col" width= "20%">Visitor's Name </th>
  ...
  <div class="mx-4">
   <div class="col-md-20 mt-4" id="divTableDidNotArriveV">
      <div class="card  px-3 py-3 ">
        <div class="table-responsive">
          <table class="table table-striped table-hover" id="querytblDidNotArriveV">
            <thead>
              <tr role="row">
                <th scope="col" width= "10%">Visit ID</th>
                <th scope="col" width= "20%">Visitor's Name </th>
  ...
  <div class="mx-4">
   <div class="col-md-20 mt-4" id="divTableArrivedV">
      <div class="card  px-3 py-3 ">
        <div class="table-responsive">
          <table class="table table-striped table-hover" id="querytblArrivedV">
            <thead>
              <tr role="row">
                <th scope="col" width= "10%">Visit ID</th>
                <th scope="col" width= "20%">Visitor's Name </th>
  ...
  <div class="mx-4">
   <div class="col-md-20 mt-4" id="divTableAllV">
      <div class="card  px-3 py-3 ">
        <div class="table-responsive">
          <table class="table table-striped table-hover" id="querytblAllV">
            <thead>
              <tr role="row">
                <th scope="col" width= "10%">Visit ID</th>
                <th scope="col" width= "20%">Visitor's Name </th>
 ...
 <script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    $('#divTableForVisitingV').hide();
    $('#divTableRejectedV').hide();
     $('#divTableArrivedV').hide();
...
<script type="text/javascript">
  ...
  function showAllPendingV(){
  $('#querytblPendingV').dataTable().fnClearTable();
  ...
  $('#querytblPendingV').dataTable({
   ...
   function showAllForVisitingV(){
  $('#querytblForDepositV').dataTable().fnClearTable();
  ...
  function showAllRejectedV(){
  $('#querytblRejectedV').dataTable().fnClearTable();
  ...
  $('#querytblRejectedV').dataTable({
   ...
   function showAllArrivedV(){
  $('#querytblArrivedV').dataTable().fnClearTable();
  ...
  $('#querytblArrivedV').dataTable({
   ...
   function showAllDidNotArriveV(){
  $('#querytblDidNotArriveV').dataTable().fnClearTable();
  ...
  $('#querytblDidNotArriveV').dataTable({
   ...
   function showAllV(){
  $('#querytblAllV').dataTable().fnClearTable();
 ...
 $('#btnApply').click(function(event){
  ...
  if(val=='Pending'){
        $.ajax({
          type: 'ajax',
          method: 'post',
          url: '<?php echo base_url() ?>admin/showAllPendingV',
          data: data,
          async: false,
          dataType: 'json',
          success: function(data){
              ...
              $('#querytblPendingV').dataTable().fnDraw();
              $('#querytblPendingV').dataTable().fnDestroy();
            var t = $('#querytblPendingV').DataTable();
            var i;
          for(i=0; i<data.length; i++){
            t.row.add( [
            data[i].intAppointmentID,
            data[i].strFullName,
            data[i].dtAppointmentDate,
            data[i].strVisitPurpose,
            data[i].strStatus
   ...
   $.ajax({
          type: 'ajax',
          method: 'post',
          url: '<?php echo base_url() ?>admin/showAllForVisitsV',
          data: data,
          async: false,
          dataType: 'json',
          success: function(data){
  ...
  $('#divTablePendingV').hide();
   ...
   $.ajax({
          type: 'ajax',
          method: 'post',
          url: '<?php echo base_url() ?>admin/showAllArrivedV',
          data: data,
          async: false,
          dataType: 'json',
          success: function(data){
   ...
   $.ajax({
          type: 'ajax',
          method: 'post',
          url: '<?php echo base_url() ?>admin/showAllRejectedV',
          data: data,
          async: false,
          dataType: 'json',
          success: function(data){
   ...
   $.ajax({
          type: 'ajax',
          method: 'post',
          url: '<?php echo base_url() ?>admin/showAllDidNotArriveV',
          data: data,
          async: false,
          dataType: 'json',
          success: function(data){
   ...
   $.ajax({
          type: 'ajax',
          method: 'post',
          url: '<?php echo base_url() ?>admin/showAllV',
          data: data,
          async: false,
          dataType: 'json',
          success: function(data){
