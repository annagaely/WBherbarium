            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form id= "editFBForm" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <label>Box Limit:</label> <label style="color: red">*</label>
                   <input id="boxLimit1"  type="number"  name="txteBLLimit" placeholder="Box Limit" class="form-control">
                  </div>
                    <div class="form-group">
                    <label>Rack Number:</label> <label style="color: red">*</label>
                    <input id="rackNum1"  type="number"  name="txterackno" placeholder="Rack Number" class="form-control">
                  </div>
                  <div class="form-group">
                    <label>Rack Row:</label> <label style="color: red">*</label>
                    <input id="rackRow1"  type="number"  name="txterackrow" placeholder="Rack Row" class="form-control">
                  </div>
                  <div class="form-group">
                    <label>Rack Column:</label> <label style="color: red">*</label>
                    <input id="rackCol1"  type="number"  name="txterackcol" placeholder="Rack Column" class="form-control">
                  </div>
                  <div class="modal-footer">
                    <input type="reset" value="Clear" class="btn btn-secondary">
