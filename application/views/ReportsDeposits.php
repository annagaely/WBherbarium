...
if(data.intcount!=0){
 ...
 // }, 5000);
      ...
      <div class="breadcrumb-holder">
          ...
          <form method="post" action="<?php echo base_url(); ?>admin/depositpdf" enctype="multipart/form-data">

  <div class="container-fluid mt-4">
  <div class="row">

   <div class="col-md-4">
             <label>Select Deposit Status:</label><br/>
          <select name='status' class="form-control">
            <option value='Pending'>Pending</option>
            <option value='For Depositing'>For Depositing</option>
