              ...
              <div class="col-md-5 mx-5 my-5"">
                <form class="form-horizontal">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                     <select class="form-control"><option>&nbsp</option></select>
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-sm-4">
                      <label style="font-size: 14px;">Taxon Name:</label>
                    </div>
                    <div class="col-sm-8">
                       <select class="form-control"><option>&nbsp</option></select>
                    </div>
                  ...
                  <div class="form-group row">
                    <div class="col-sm-4">
                      <label style="font-size: 14px;">Available Specimens:</label>
                    </div>
                    <div class="col-sm-8">
                  ...
                  <div class="form-group row">
                    <div class="col-sm-4">
                      <label style="font-size: 14px;">Date of Loan:</label>
                    </div>
                    <div class="col-sm-8">
                      <input type="Date" name="txtdName" id="strDomainName" class="form-control">
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-8"><div class="row"><div class="col-sm-3">
                      <input type="text" name="txtdName" id="strDomainName" class="form-control" style="width: 50px"></div>
                      <div class="col-sm-3"><select class="form-control" style="width: 100px"><option>&nbsp</option><option>Day/s</option><option>Month/s</option></select>
                    </div></div></div>
                  </div>
                   <div class="form-group row">
                    <div class="col-sm-4">
                      <label style="font-size: 14px;">Purpose of Loan:</label>
                    </div>
                    <div class="col-sm-8">
                  ...
                  <input type="reset" value="Clear" class="btn btn-primary">       
                    <input type="submit" value="Process" id='btnEditSave' class="btn btn-primary">
                  </div>
                </form>
              </div>
