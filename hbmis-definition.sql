...
GO
-- Events
IF OBJECT_ID('tblEvents', 'U') IS NOT NULL
	DROP TABLE tblEvents
GO
CREATE TABLE tblEvents
(
	intEventID INT IDENTITY(1000, 1) NOT NULL,
	strEventName VARCHAR(100) NOT NULL,
	dtStartDate date NOT NULL,
	dtEndDate date NOT NULL,
	strEventDesc VARCHAR(255) NOT NULL
	CONSTRAINT pk_tblEvents PRIMARY KEY (intEventID)
...
(
	...
	strPresentAddress VARCHAR(255),
	strPermanentAddress VARCHAR(255),
	CONSTRAINT pk_tblPerson PRIMARY KEY(intPersonID)
)
GO
-- Person -> Online Users
IF OBJECT_ID('tblOnlineUser', 'U') IS NOT NULL
	DROP TABLE tblOnlineUser
GO
CREATE TABLE tblOnlineUser
(
	intOUserID INT IDENTITY(1000, 1) NOT NULL,
	intPersonID INT NOT NULL,
	strAffiliationName VARCHAR(100) NOT NULL,
	strAffiliationAddress VARCHAR(255) NOT NULL,
	strAffiliationPosition VARCHAR(100) NOT NULL,
	strUserName VARCHAR(50) not null,
	strPassword VARCHAR(50) not null,
	CONSTRAINT pk_tblOnlineUser PRIMARY KEY(intOUserID),
	CONSTRAINT fk_tblOnlineUser_tblPerson FOREIGN KEY(intPersonID)
		REFERENCES tblPerson(intPersonID)
)
GO
-- Appointments
IF OBJECT_ID('tblAppointments', 'U') IS NOT NULL
	DROP TABLE tblAppointments
GO
CREATE TABLE tblAppointments
(
	intAppointmentID INT IDENTITY(1000, 1) NOT NULL,
	strAppointmentType VARCHAR(50) NOT NULL,
	dtAppointmentDate date NOT NULL,
	intOUserID int NOT NULL,
	strVisitDescription varchar(255) not null
	CONSTRAINT pk_tblAppointments PRIMARY KEY (intAppointmentID),
	CONSTRAINT fk_tblAppointments_tblOnlineUser FOREIGN KEY (intOUserID)
		REFERENCES tblOnlineUser(intOUserID)
)
GO	
-- Loan Requests
IF OBJECT_ID('tblLoanReq', 'U') IS NOT NULL
	DROP TABLE tblLoanReq
GO
CREATE TABLE tblLoanReq
(
	intLoanReqID INT IDENTITY(1000, 1) NOT NULL,
	intOUserID INT NOT NULL,
	strDuration date NOT NULL,
	strPurpose varchar(255) not null
	CONSTRAINT pk_tblLoanReq PRIMARY KEY (intLoanReqID),
	CONSTRAINT fk_tblLoanReq_tblOnlineUser FOREIGN KEY (intOUserID)
		REFERENCES tblOnlineUser(intOUserID)
)
GO
-- Loan List
IF OBJECT_ID('tblLoanList', 'U') IS NOT NULL
	DROP TABLE tblLoanList
GO
CREATE TABLE tblLoanList
(
	intLoanListID INT IDENTITY(1000, 1) NOT NULL,
	intLoanReqID INT NOT NULL,
	intFamilyID int NOT NULL,
	intGenusID int not null,
	intSpeciesID int not null
	CONSTRAINT pk_tblLoanList PRIMARY KEY (intLoanListID),
	CONSTRAINT fk_tblLoanList_tblFamily FOREIGN KEY (intFamilyID)
		REFERENCES tblFamily(intFamilyID),
	CONSTRAINT fk_tblLoanList_tblGenus FOREIGN KEY (intGenusID)
		REFERENCES tblGenus(intGenusID),
	CONSTRAINT fk_tblLoanList_tblSpecies FOREIGN KEY (intSpeciesID)
